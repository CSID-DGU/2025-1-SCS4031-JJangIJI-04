...
public class RestaurantService {
    ...
    public void createRestaurants(List<RestaurantCreateRequest> requests) {
        ...
        for (RestaurantCreateRequest request : requests) {
            ...
            Category category = categoryMapper.mapByKeyword(request.category());
            Restaurant restaurant = new Restaurant(category, request.name(), request.id(), request.menu_average());
